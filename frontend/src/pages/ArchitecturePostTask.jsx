  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen text-white p-4 md:p-6 overflow-hidden">
      ...
      >
        ...
        <input
          type="text"
          placeholder="e.g., 3D Elevation for Residential House"
          value={title}
        ...
        {/* Project Types */}
        <label className="block mb-2 text-lg">Project Type</label>
          ...
          {projectTypeOptions.map((type) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ scale: 1.05 }}
                key={type}
                onClick={() => toggleSelection(type, projectTypes, setProjectTypes)}
        ...
        {/* Area Size */}
        <label className="block mb-2 text-lg">Area Size (sq.ft / sq.m)</label>
        <input
          type="text"
        ...
        {/* Styles */}
        <label className="block mb-2 text-lg">Preferred Styles</label>
        <div className="flex flex-wrap gap-2 mb-4">
          {styleOptions.map((style) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ scale: 1.05 }}
                key={style}
                onClick={() => toggleSelection(style, styles, setStyles)}
                className={`px-4 py-2 rounded-full cursor-pointer transition-all text-sm md:text-base
                  ${selected
                    ? "bg-purple-600 border border-purple-400 shadow-lg shadow-purple-500/40"
                    : "bg-[#1f1f1f]/80 border border-gray-700 hover:border-purple-400"}
        ...
        <textarea
          placeholder="Describe your design requirements, inspirations, or constraints..."
          rows="4"
          value={description}
